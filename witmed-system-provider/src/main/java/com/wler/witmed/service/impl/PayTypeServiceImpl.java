...
import com.wler.witmed.dao.PayTypeDao;
...
public class PayTypeServiceImpl implements PayTypeService {
	...
	@Override
	public PageVO<PayType> getPageByQuery(PayType query, PageVO<PayType> pageVO) throws Exception {
		// 打开 PageHelper 的分页过滤器,会将紧挨着的数组进行分页
		PageHelper.startPage(pageVO.getPageNum(), pageVO.getPageSize());
		List<PayType> list = dao.findListByQuery(query);
		// 获得 PageInfo 对象获得数据
